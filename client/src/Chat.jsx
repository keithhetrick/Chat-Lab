...
const Chat = () => {
  ...
  const MOBILE_VIEW = (
    <div id="window__section" className="flex h-screen relative">
      {/*
        SIDEBAR SECTION
      */}
      <aside
        id="sidebar__section"
        className="bg-[#f6f6f6] sm:w-1/3 flex flex-col absolute z-30"
      >
        {/* 
        ...
        */}
        <div
          ...
          // onClick={isSelected || selectedUserId ? toggleDropdown : () => {}}
          onClick={toggleDropdown}
        >
          <header className="flex flex-col justify-center items-center h-full w-fit cursor-pointer hover:animate-pulse">
          ...
          {isDropdownOpen ? (
            <div id="sidebar__wrapper" className="transition duration-300">
              <button
                className={
                  "border-b border-gray-200 flex items-center cursor-pointer transition w-full min-h-full " +
              ...
              <button
                className="flex p-3 px-6 w-full items-center cursor-pointer justify-between hover:transform hover:scale-105 transition-all duration-100 "
                onClick={handleAiChannelSelect}
              >
              ...
              <div
                id="contacts__list"
                className="flex-auto text-xs sm:text-base"
              >
      ...
      */}
      <section
        ...
        className="flex flex-col bg-blue-50 w-full"
      >
        <div className="flex w-full">
          <Logo />
          <div
            id="user__header"
            className="w-3/4 border h-8 bg-slate-100 text-sm text-center align-middle items-center self-end text-gray-600 flex justify-end p-2"
          >
            {username}
        ...
        {!!selectedUserId && (
          ...
          <form
            ...
            className="flex gap-2 px-2 pb-2 overflow-auto z-10"
